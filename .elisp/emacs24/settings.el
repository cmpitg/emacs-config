...
(custom-set-variables
 ...
 '(face-font-family-alternatives (quote (("Monaco" "Consolas" "Monospace") ("Monaco" "Consolas" "CMU Typewriter Text" "fixed") ("Geneva" "Sans Serif" "helv" "helvetica" "arial" "fixed") ("helv" "helvetica" "arial" "fixed"))))
 '(load-home-init-file t t)
 '(rst-adornment-faces-alist (quote ((t . font-lock-keyword-face) (nil . font-lock-keyword-face) (1 . font-lock-function-name-face) (2 . font-lock-function-name-face) (3 . font-lock-function-name-face) (4 . font-lock-function-name-face) (5 . font-lock-function-name-face) (6 . font-lock-function-name-face) (1 . font-lock-function-name-face) (2 . font-lock-function-name-face) (3 . font-lock-function-name-face) (4 . font-lock-function-name-face) (5 . font-lock-function-name-face) (6 . font-lock-function-name-face))))
 ...
 '(default ((t (:inherit nil :stipple nil :background "gray12" :foreground "green" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "unknown" :family "Monaco"))))
 '(cursor ((t (:background "cyan" :foreground "gray"))))
 '(mode-line ((t (:background "grey75" :foreground "#3d3d3d" :inverse-video t :box (:line-width 1 :color "#000000" :style released-button) :slant normal :weight normal :height 100 :family "Geneva"))))
